...
- `./tmp/devstate.json`: dev ready, tests pass, check pass. `./tmp/state.txt` was not generated by current `bun start`; stdout reported `State ./tmp/devstate.json`.
...
- `./tmp/devstate.json`: dev ready, tests pass, check pass. `./tmp/state.txt` was not generated by current `bun start`; stdout reported `State ./tmp/devstate.json`.
- `./tmp/test.txt`: latest watcher rerun passed for `src/app.test.tsx` with 65 tests; `./tmp/devstate.json` reported `testStatus: "pass"`.
