...
Read these before domain-sensitive engineering work:

- `CONTEXT.md`
- `doc/README.md`
- relevant `doc/topics/*.md`
- relevant GitHub PRD issue
- relevant legacy `prd/*.md` only when assigned or retiring it
