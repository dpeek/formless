...
| ----------- | ------- | -------------------------- | -------------------- | ------------------------------------------------- | -------------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Create      | Editor  | draft/default              | required or optional | field/editor-derived                              | visible                                      | submit                    | `src/app/generated/generated-create-runtime.ts`; `src/app/generated/legacy-generated-create.tsx` `GeneratedCreateForm`, `GeneratedCreateDialogForm`; `src/app/generated/create-field-control.tsx` `GeneratedCreateFieldControl` |
| Record      | Editor  | committed value plus draft | required or optional | normal, compact, or heading as selected by layout | hidden by default; accessible label retained | immediate or field commit | `src/app/generated/generated-list-foundation.ts`; `src/app/generated/legacy-list-renderer.tsx`; `src/app/generated/record-field-editor.tsx` `RecordFieldEditor`                                                                 |
...
| Table Cell  | Editor  | committed value plus draft | required or optional | compact                                           | hidden; table header supplies column label   | immediate or field commit | `src/app/generated/generated-table-foundation.tsx`; `src/app/generated/legacy-generated-table-runtime.tsx`; `src/app/generated/legacy-table-renderer.tsx`; `src/app/generated/record-field-editor.tsx` `RecordFieldEditor`      |
| Table Cell  | Display | committed value            | required or optional | compact                                           | hidden; table header supplies column label   | not applicable            | `src/app/generated/generated-table-foundation.tsx`; `src/app/generated/legacy-generated-table-runtime.tsx`; `src/app/generated/legacy-table-renderer.tsx`; `src/app/generated/record-field-display.tsx` `RecordFieldDisplay`    |
| Item Detail | Editor  | committed value plus draft | required or optional | normal                                            | visible                                      | immediate or field commit | `src/app/generated/generated-record-result-foundation.ts`; `src/app/generated/legacy-record-result-renderer.tsx`                                                                                                                |
...
| Record      | Display with optional transition controls elsewhere in the row | Active, Terminal, Unset, Undeclared | no direct editing | badge; terminal uses dashed treatment | hidden by default; badge has accessible state label | transition operation           | `src/app/generated/record-field-editor.tsx` `StateMachineRecordField`; `src/app/generated/legacy-state-machine-ui.tsx` `StateMachineStateBadge`, `RecordTransitionOperationControls`; `src/app/generated/state-machine-operation-runtime.ts` execution |
| Table Cell  | Display or transition menu                                     | Active, Terminal, Unset, Undeclared | no direct editing | compact badge; terminal distinguished | hidden; menu trigger has accessible state label     | transition operation from menu | `src/app/generated/generated-table-foundation.tsx`; `src/app/generated/legacy-table-renderer.tsx`; `src/app/generated/legacy-state-machine-ui.tsx` `RecordStateTransitionMenu`; `src/app/generated/state-machine-operation-runtime.ts` execution       |
| Item Detail | Display with transition controls                               | Active, Terminal, Unset, Undeclared | no direct editing | badge; terminal distinguished         | visible                                             | transition operation           | `src/app/generated/generated-record-result-foundation.ts`; `src/app/generated/legacy-state-machine-ui.tsx` presentation; `src/app/generated/state-machine-operation-runtime.ts` execution                                                              |
...
| Item Detail | Editor  | Known, Unset, Undeclared                          | required and optional                             | plain or rich select                               | visible                                                                    | immediate      | `src/app/generated/generated-record-result-foundation.ts`; `src/app/generated/record-field-control.tsx` enum authoring                                                   |
...
| Item Detail | Editor  | Known, Unset, missing reference id | required and optional                                                          | label select                         | visible                                      | immediate      | `src/app/generated/generated-record-result-foundation.ts`; `src/app/generated/record-field-control.tsx`                          |
...
| Item Detail | Editor  | Known, Unset | required and optional | normal text                                 | visible                                             | field commit on blur; Enter commits; Escape reverts | `src/app/generated/generated-record-result-foundation.ts`; `src/app/generated/record-field-control.tsx`                                 |
...
| Item Detail | Editor  | Known, Unset | required and optional | textarea                                      | visible           | field commit on blur; Escape reverts | `src/app/generated/generated-record-result-foundation.ts`                                                                                   |
...
| Item Detail | Editor  | Known, Unset | required and optional | Markdown source editor                              | visible           | field commit on blur; Escape reverts | `src/app/generated/generated-record-result-foundation.ts`; `src/app/generated/record-field-control.tsx`                                                                 |
...
| Item Detail | Editor  | Known, Unset, invalid draft                               | required and optional | number or value-unit control                                          | visible           | field commit                                  | `src/app/generated/generated-record-result-foundation.ts`                                                       |
...
| Item Detail | Editor  | Known, Unset                                   | required and optional | normal date picker                             | visible           | field commit                                            | `src/app/generated/generated-record-result-foundation.ts`                                         |
...
| Item Detail | Editor  | true, false                                    | required and optional | checkbox or completion                               | visible                                  | immediate                  | `src/app/generated/generated-record-result-foundation.ts`                                                                          |
...
| Item Detail | Editor  | same as Record                                               | required and optional | normal color input                                                           | visible           | field commit         | `src/app/generated/generated-record-result-foundation.ts`                               |
...
| Item Detail | Editor  | same as Record                                                  | required and optional | normal picker                                | visible           | picker Save                                        | `src/app/generated/generated-record-result-foundation.ts`                                                                                          |
...
| Item Detail | Editor  | same as Record                                           | required and optional | normal media control                                             | visible           | picker/upload patch                  | `src/app/generated/generated-record-result-foundation.ts`                                                                                                      |
...
| Tree Child  | Editor  | same as Record plus tree create                          | required and optional | selected child media control or child-create media control       | visible           | picker/upload patch or create draft  | `src/app/generated/generated-tree-foundation.ts`; `src/app/generated/generated-tree-create-foundation.ts`; `src/app/generated/generated-workspace-runtime.tsx` |

Public operation Media inputs are unsupported. The canonical Site
`blockCreate` operation owns its media field through the Create surface instead
of an operation-input field.

#### Current Astryx coverage

`lib/astryx/src/components/fields/media-field.fixtures.ts` covers Create,
Record, Table Cell, and Item Detail; editor and display modes where supported;
required and optional fields; selected, missing, and Unset values; compact
density; and uploading state. Tree fields reuse the Record and Create
contracts. Public Operation has no Media fixture because the canonical public
operation input projection excludes Media.

#### Cutover parity evidence

- `src/app/generated/media-presentation-conformance.test.ts` inventories all
  five live Site schema declarations and projects them through canonical
  create, record, table, detail, and tree field occurrences.
- `lib/astryx/src/components/fields/media-field-conformance.test.tsx` renders
  the complete Astryx Media matrix and verifies asset-selection and file-select
  intents for each authoring surface.
- Media reads, options, uploads, preview resolution, flat patch planning, and
  effects remain in generated runtime and Media client owners.

#### Contract facts to make explicit

Create, record, table, detail, and tree projection explicitly carry selected or
missing asset state, preview href, asset options, upload policy, pending state,
and flat patch fields. Astryx consumes those facts without importing Media
React.

#### Optional improvements

- Richer Media library behavior remains post-migration work and requires a
  canonical contract or specification change.
...
- `src/app/generated/generated-create-runtime.ts`: create sessions,
  projection, selection, and operation execution.
- `src/app/generated/legacy-generated-create.tsx`: dormant create form and
  dialog composition.
- `src/app/generated/create-field-control.tsx`: `GeneratedCreateFieldControl` and field-specific Create controls.
- `src/app/generated/generated-list-foundation.ts` and `legacy-list-renderer.tsx`: generated record-row projection and legacy presentation.
- `src/app/generated/generated-record-result-foundation.ts` and `legacy-record-result-renderer.tsx`: generated item-detail projection and legacy presentation.
- `src/app/generated/generated-table-foundation.tsx`: live table projection,
  selection, and operation execution.
- `src/app/generated/legacy-generated-table-runtime.tsx` and
  `legacy-table-renderer.tsx`: dormant table state/effects and presentation.
- `src/app/generated/table.tsx`: dormant `RecordTable` wrapper and referenced
  record editor.
...
- `src/app/generated/legacy-state-machine-ui.tsx`: dormant badges and
  transition buttons/menus.
- `src/app/generated/state-machine-operation-runtime.ts`: live transition
  operation execution.
