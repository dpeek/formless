...
export const LOCAL_WORKSPACE_GATEWAY_SIDECAR_URL_ENV = "FORMLESS_WORKSPACE_GATEWAY_SIDECAR_URL";
export const LOCAL_WORKSPACE_GATEWAY_PROXY_TOKEN_ENV = "FORMLESS_WORKSPACE_GATEWAY_PROXY_TOKEN";
...
export const LOCAL_WORKSPACE_GATEWAY_PROXY_AUTHORIZATION_HEADER =
  "x-formless-workspace-proxy-token";
export const LOCAL_WORKSPACE_GATEWAY_ACTOR_HEADER = "x-formless-workspace-actor";
export const LOCAL_WORKSPACE_GATEWAY_AUTHORIZATION_VIA_HEADER =
  "x-formless-workspace-authorization-via";
export const LOCAL_WORKSPACE_GATEWAY_OPERATION_KIND_HEADER = "x-formless-workspace-operation-kind";
