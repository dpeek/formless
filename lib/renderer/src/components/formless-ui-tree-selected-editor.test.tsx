...
} from "./formless-ui-tree-selected-editor.tsx";
import {
...
describe("Astryx tree selected-item editor", () => {
  ...
  it("retains responsive placement and the pure canonical renderer boundary", async () => {
    ...
    expect(editorSource).toContain("FormlessUiFieldRenderer");
...
function renderTree(id: FormlessUiTreeResultFixtureId) {
...
function requiredField(fields: readonly FormlessUiField[], fieldName: string) {
