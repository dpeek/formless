...
} from "./formless-ui-tree-child-creation.tsx";
import {
...
describe("Astryx tree child creation", () => {
  ...
  it("keeps runtime policy, execution, output, writes, and created selection outside Astryx", async () => {
    const source = await readFile(
      new URL("./formless-ui-tree-child-creation.tsx", import.meta.url),
      "utf8",
    );
...
function renderCreation(
  ...
  onIntent: (intent: FormlessUiTreeIntent) => void = () => undefined,
) {
