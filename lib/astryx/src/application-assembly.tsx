...
export type AstryxApplicationPresentation =
  | {
...
export type AstryxApplicationAssemblyProps = {
  presentation: AstryxApplicationPresentation;
};

export function AstryxApplicationAssembly({ presentation }: AstryxApplicationAssemblyProps) {
